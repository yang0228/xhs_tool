...
class Draft(Base):
    ...
    content_iv: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    encryption_version: Mapped[int] = mapped_column(Integer, default=1, server_default="1", nullable=False)
    image_ids: Mapped[list[str]] = mapped_column(ARRAY(String(36)), default=list, server_default="{}", nullable=False)
